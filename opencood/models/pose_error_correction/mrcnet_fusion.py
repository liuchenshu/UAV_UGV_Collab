...
from opencood.models.pose_error_correction.feature_selection import MostInformativeFeaSelection
...
class MSRobustFusion(nn.Module):
    ...
    def forward(self, batch_dict_list, record_len):
        ...
        return target_batch_dict, total_comm_volume,encoded_feature[0]
